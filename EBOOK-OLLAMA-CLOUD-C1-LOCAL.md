...
- HTTP **429** = Too Many Requests · **502** = Bad Gateway (cloud unreachable) — docs api/errors.
...
4. Retry **só** 429/502 com `Retry-After` / backoff.
...
- Confirmar IDs vivos com `GET /api/tags` — nunca inventar nomes; ver retirements em docs cloud.
...
- HF Space: https://ziulluizziul-ollama-kit-anti-429.static.hf.space/
